        ...
        try {
          const response = await fetch(url, {
            ...
            headers: {
              ...
              Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIxOTg5Y2I1MmRiZTBiNGJhZjAxMDQ0ZTdiYWNhMmNhMiIsInN1YiI6IjY2MmYxZTc1MDI4ZjE0MDEyYjY5MjU3ZCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.cTLRXPVVeEPhtyW5NBbxNpwCgBJwVd527QRpY6SZKOQ', // Replace with your actual API key
            },
          });
