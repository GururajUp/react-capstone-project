    ...
    return (
        <div className='container4'>
            <div className='Timer'>
                ...
                <div className='Hours'>
                    <p>Hours</p>
                    <img src={Up} alt='icon' onClick={increaseHours} />
                    <h2>{formatValue(hours)} </h2>
                    <img src={Down} alt='icon' onClick={decreaseHours} />
                </div>
                <h1 >:</h1>
                <div className='Minutes'>
                    <p>Minutes</p>
                    <img src={Up} alt='icon' onClick={increaseMinutes} />
                    <h2>{formatValue(minutes)}</h2>
                    <img src={Down} alt='icon' onClick={decreaseMinutes} />
                </div>
                <h1>:</h1>
                <div className='Seconds'>
                    <p>Seconds</p>
                    <img src={Up} alt='icon' onClick={increaseSeconds} />
                    <h2>{formatValue(seconds)}</h2>
                    <img src={Down} alt='icon' onClick={decreaseSeconds} />
                </div>
            </div>
